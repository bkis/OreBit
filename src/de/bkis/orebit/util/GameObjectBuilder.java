...
import de.bkis.orebit.controls.AsteroidMassIndicatorControl;
import de.bkis.orebit.controls.FlightControl;
import de.bkis.orebit.controls.ForcesControl;
import de.bkis.orebit.controls.MagnetControl;
import de.bkis.orebit.controls.MoonControl;
import de.bkis.orebit.controls.ShipGravityIndicatorControl;
import de.bkis.orebit.controls.ThrusterVisualsControl;
import de.bkis.orebit.data.AsteroidData;
import de.bkis.orebit.data.BaseData;
import de.bkis.orebit.data.CheckpointData;
import de.bkis.orebit.data.MagnetData;
import de.bkis.orebit.data.OreData;
import de.bkis.orebit.data.PlanetData;
import de.bkis.orebit.data.MoonData;
import de.bkis.orebit.entities.AbstractGameObject;
import de.bkis.orebit.entities.Asteroid;
import de.bkis.orebit.entities.Base;
import de.bkis.orebit.entities.Ore;
import de.bkis.orebit.entities.Planet;
import de.bkis.orebit.entities.Moon;
...
public class GameObjectBuilder {
    ...
    public Ship buildShip(int thrust, int spin, int grabberLength, int fuel, int booster){
        ...
        Geometry shipGeom = (Geometry)((Node)((Node)shipModel).getChild("ship")).getChild("ship1");
        shipGeom.scale(0.7f,0.7f,0.2f);
        shipGeom.getMaterial().setColor("Ambient", ColorRGBA.White);
